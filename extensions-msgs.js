...
export default {
  ...
  "zh-tw": {
    ...
    "arduinoEsp32.InterrupModeMenu.changeEdge": "mudar borda",
    ...
    "arduinoEsp32.category.serial": "Serial",
    "arduinoEsp32.data.dataConstrain": "restringir [DATA] entre ([ARG0], [ARG1])",
    ...
    "arduinoEsp32.eolMenu.warp": "com quebra de linha",
    ...
    "arduinoEsp32.pins.esp32AttachInterrupt": "vincular pino de interrupção [PIN] modo [MODE] executa",
    "arduinoEsp32.pins.esp32DetachInterrupt": "desvincular pino de interrupção [PIN]",
    "arduinoEsp32.pins.esp32ReadTouchPin": "ler pino de toque [PIN]",
    "arduinoEsp32.pins.esp32SetDACOutput": "configurar pino DAC [PIN] como [OUT]",
    "arduinoEsp32.pins.esp32SetPwmOutput": "configurar pino PWM [PIN] usando canal [CH] como [OUT]",
    "arduinoEsp32.pins.readAnalogPin": "ler pino analógico [PIN]",
    "arduinoEsp32.pins.readDigitalPin": "ler pino digital [PIN]",
    "arduinoEsp32.pins.setDigitalOutput": "configurar pino digital [PIN] como [LEVEL]",
    "arduinoEsp32.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
    "arduinoEsp32.pins.setServoOutput": "configurar pino servo [PIN] usando canal [CH] como [OUT]",
    "arduinoEsp32.serial.multiSerialAvailable": "tamanho dos dados disponíveis na serial [NO]",
    ...
    "arduinoEsp8266.InterrupModeMenu.changeEdge": "mudar borda",
    ...
    "arduinoEsp8266.category.serial": "Serial",
    "arduinoEsp8266.data.dataConstrain": "restringir [DATA] entre ([ARG0], [ARG1])",
    ...
    "arduinoEsp8266.eolMenu.warp": "com quebra de linha",
    ...
    "arduinoEsp8266.pins.detachInterrupt": "desvincular pino de interrupção [PIN]",
    "arduinoEsp8266.pins.esp8266AttachInterrupt": "vincular pino de interrupção [PIN] modo [MODE] executa",
    "arduinoEsp8266.pins.readAnalogPin": "ler pino analógico [PIN]",
    "arduinoEsp8266.pins.readDigitalPin": "ler pino digital [PIN]",
    "arduinoEsp8266.pins.setDigitalOutput": "configurar pino digital [PIN] como [LEVEL]",
    "arduinoEsp8266.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
    "arduinoEsp8266.pins.setPwmOutput": "configurar pino PWM [PIN] como [OUT]",
    "arduinoEsp8266.pins.setServoOutput": "configurar pino servo [PIN] como [OUT]",
    "arduinoEsp8266.serial.serialAvailable": "tamanho dos dados disponíveis na serial",
    "arduinoEsp8266.serial.serialBegin": "iniciar serial com taxa de transmissão [VALUE]",
    "arduinoEsp8266.serial.serialPrint": "imprimir [VALUE] na serial [EOL]",
    "arduinoEsp8266.serial.serialReadData": "ler dados da serial",
    "arduinoK210.InterrupModeMenu.changeEdge": "mudar borda",
    ...
    "arduinoK210.category.serial": "Serial",
    "arduinoK210.data.dataConstrain": "restringir [DATA] entre ([ARG0], [ARG1])",
    ...
    "arduinoK210.eolMenu.warp": "com quebra de linha",
    ...
    "arduinoK210.pins.attachInterrupt": "vincular pino de interrupção [PIN] modo [MODE] executa",
    "arduinoK210.pins.detachInterrupt": "desvincular pino de interrupção [PIN]",
    "arduinoK210.pins.readAnalogPin": "ler pino analógico [PIN]",
    "arduinoK210.pins.readDigitalPin": "ler pino digital [PIN]",
    "arduinoK210.pins.setDigitalOutput": "configurar pino digital [PIN] como [LEVEL]",
    "arduinoK210.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
    "arduinoK210.pins.setPwmOutput": "configurar pino PWM [PIN] como [OUT]",
    "arduinoK210.pins.setServoOutput": "configurar pino servo [PIN] como [OUT]",
    "arduinoK210.serial.multiSerialAvailable": "tamanho dos dados disponíveis na serial [NO]",
    "arduinoK210.serial.multiSerialBegin": "iniciar serial [NO] com taxa de transmissão [VALUE]",
    ...
    "arduinoLeonardo.InterrupModeMenu.changeEdge": "mudar borda",
    ...
    "arduinoLeonardo.category.serial": "Serial",
    "arduinoLeonardo.data.dataConstrain": "restringir [DATA] entre ([ARG0], [ARG1])",
    ...
    "arduinoLeonardo.eolMenu.warp": "com quebra de linha",
    ...
    "arduinoLeonardo.pins.attachInterrupt": "vincular pino de interrupção [PIN] modo [MODE] executa",
    "arduinoLeonardo.pins.detachInterrupt": "desvincular pino de interrupção [PIN]",
    "arduinoLeonardo.pins.readAnalogPin": "ler pino analógico [PIN]",
    "arduinoLeonardo.pins.readDigitalPin": "ler pino digital [PIN]",
    "arduinoLeonardo.pins.setDigitalOutput": "configurar pino digital [PIN] como [LEVEL]",
    "arduinoLeonardo.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
    "arduinoLeonardo.pins.setPwmOutput": "configurar pino PWM [PIN] como [OUT]",
    "arduinoLeonardo.pins.setServoOutput": "configurar pino servo [PIN] como [OUT]",
    "arduinoLeonardo.serial.serialAvailable": "tamanho dos dados disponíveis na serial",
    "arduinoLeonardo.serial.serialBegin": "iniciar serial com taxa de transmissão [VALUE]",
    "arduinoLeonardo.serial.serialPrint": "imprimir [VALUE] na serial [EOL]",
    "arduinoLeonardo.serial.serialReadData": "ler dados da serial",
    "arduinoMega2560.InterrupModeMenu.changeEdge": "mudar borda",
  "arduinoMega2560.InterrupModeMenu.fallingEdge": "borda de descida",
  ...
  "arduinoMega2560.eolMenu.warp": "com quebra de linha",
  "arduinoMega2560.levelMenu.high": "alto",
  "arduinoMega2560.levelMenu.low": "baixo",
  "arduinoMega2560.modeMenu.input": "entrada",
  "arduinoMega2560.modeMenu.inputPullup": "entrada com resistor pull-up",
  "arduinoMega2560.modeMenu.output": "saída",
  "arduinoMega2560.pins.attachInterrupt": "vincular pino de interrupção [PIN] modo [MODE] executa",
  "arduinoMega2560.pins.detachInterrupt": "desvincular pino de interrupção [PIN]",
  "arduinoMega2560.pins.readAnalogPin": "ler pino analógico [PIN]",
  "arduinoMega2560.pins.readDigitalPin": "ler pino digital [PIN]",
  "arduinoMega2560.pins.setDigitalOutput": "configurar pino digital [PIN] como [LEVEL]",
  "arduinoMega2560.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
  "arduinoMega2560.pins.setPwmOutput": "configurar pino PWM [PIN] como [OUT]",
  "arduinoMega2560.pins.setServoOutput": "configurar pino servo [PIN] como [OUT]",
  "arduinoMega2560.serial.multiSerialAvailable": "tamanho dos dados disponíveis na serial [NO]",
  "arduinoMega2560.serial.multiSerialBegin": "iniciar serial [NO] com taxa de transmissão [VALUE]",
  "arduinoMega2560.serial.multiSerialPrint": "imprimir [VALUE] na serial [NO] [EOL]",
  "arduinoMega2560.serial.multiSerialReadAByte": "ler um byte na serial [NO]",
  "arduinoPeripheral.connection.connectFirmataTimeout": "Tempo limite ao tentar conectar Firmata, por favor, faça o download do firmware primeiro",
    "arduinoRaspberryPiPico.InterrupModeMenu.changeEdge": "mudar borda",
    "arduinoRaspberryPiPico.InterrupModeMenu.fallingEdge": "borda de descida",
    ...
    "arduinoRaspberryPiPico.eolMenu.warp": "com quebra de linha",
    ...
    "arduinoRaspberryPiPico.modeMenu.inputPulldown": "entrada com resistor pulldown",
    "arduinoRaspberryPiPico.modeMenu.inputPullup": "entrada com resistor pullup",
    "arduinoRaspberryPiPico.modeMenu.output": "saída",
    "arduinoRaspberryPiPico.pins.attachInterrupt": "vincular pino de interrupção [PIN] modo [MODE] executa",
    "arduinoRaspberryPiPico.pins.detachInterrupt": "desvincular pino de interrupção [PIN]",
    ...
    "arduinoRaspberryPiPico.pins.setDigitalOutput": "configurar pino digital [PIN] como [LEVEL]",
    "arduinoRaspberryPiPico.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
    "arduinoRaspberryPiPico.pins.setPwmOutput": "configurar pino PWM [PIN] como [OUT]",
    "arduinoRaspberryPiPico.pins.setServoOutput": "configurar pino servo [PIN] como [OUT]",
    "arduinoRaspberryPiPico.serial.multiSerialAvailable": "tamanho dos dados disponíveis na serial [NO]",
    "arduinoRaspberryPiPico.serial.multiSerialPrint": "imprimir na serial [NO] [VALUE] [EOL]",
    "arduinoRaspberryPiPico.serial.multiSerialReadAByte": "ler um byte na serial [NO]",
    "arduinoRaspberryPiPico.serial.raspberryPiPicoMultiSerialBegin": "iniciar serial [NO] com taxa de transmissão [VALUE]",
    "arduinoUno.InterrupModeMenu.changeEdge": "mudar borda",
"arduinoUno.InterrupModeMenu.fallingEdge": "borda de queda",
"arduinoUno.InterrupModeMenu.low": "baixo",
...
"arduinoUno.pins.attachInterrupt": "anexar interrupção ao pino [PIN] no modo [MODE]",
"arduinoUno.pins.detachInterrupt": "remover interrupção do pino [PIN]",
...
"arduinoUno.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
"arduinoUno.pins.setPwmOutput": "definir saída PWM do pino [PIN] como [OUT]",
"arduinoUno.pins.setServoOutput": "definir saída do pino servo [PIN] como [OUT]",
"arduinoUno.serial.serialAvailable": "comprimento dos dados disponíveis na serial",
"arduinoUno.serial.serialBegin": "iniciar serial com taxa de transmissão [VALUE]",
"arduinoUno.serial.serialPrint": "imprimir na serial [VALUE] [EOL]",
"arduinoUno.serial.serialReadData": "ler dados da serial",
...
"boost.motorDirection.backward": "nesse sentido",
"boost.motorDirection.forward": "nesse sentido",
"boost.motorDirection.reverse": "invertido",
...
"boost.seeingColor": "detectando tijolo [COLOR]?",
...
"boost.whenColor": "quando detectar tijolo [COLOR]",
"boost.whenTilted": "quando inclinado [TILT_DIRECTION_ANY]",

"ev3.beepNote": "emitir som nota [NOTE] por [TIME] segundos",
...
"ev3.motorSetPower": "definir potência do motor [PORT] como [POWER] %",
"ev3.motorTurnClockwise": "girar motor [PORT] nesse sentido por [TIME] segundos",
"ev3.motorTurnCounterClockwise": "girar motor [PORT] nesse sentido por [TIME] segundos",
...
"gdxfor.isFreeFalling": "em queda livre?",
...
"gdxfor.whenForcePushedOrPulled": "quando sensor de força [PUSH_PULL]",
...
"makeymakey.whenKeyPressed": "quando tecla [KEY] pressionada",
"makeymakey.whenKeysPressedInOrder": "quando [SEQUENCE] pressionado em ordem",
"microPythonEsp32.InterrupModeMenu.changeEdge": "mudar borda",
    "microPythonEsp32.InterrupModeMenu.fallingEdge": "borda de descida",
    ...
    "microPythonEsp32.eolMenu.warp": "quebra de linha",
    ...
    "microPythonEsp32.pins.esp32AttachInterrupt": "vincular interrupção no pino [PIN] no modo [MODE] e executar",
    ...
    "microPythonEsp32.pins.esp32SetDACOutput": "definir saída do pino DAC [PIN] como [OUT]",
    "microPythonEsp32.pins.esp32SetDigitalOutput": "definir saída digital do pino [PIN] como [LEVEL]",
    "microPythonEsp32.pins.esp32SetPinMode": "definir modo do pino [PIN] como [MODE]",
    "microPythonEsp32.pins.esp32SetPwmOutput": "definir saída PWM do pino [PIN] como [OUT]",
    "microPythonEsp32.pins.setServoOutput": "definir saída do pino de servo [PIN] como [OUT]",
    "microPythonEsp8266.category.console": "Console",
    ...
    "microPythonEsp8266.eolMenu.warp": "quebra de linha",
    ...
    "microPythonEsp8266.pins.esp8266AttachInterrupt": "interrupção do pino [PIN]modo [MODE] execução",
    "microPythonEsp8266.pins.readAnalogPin": "ler pino analógico [PIN]",
    "microPythonEsp8266.pins.readDigitalPin": "ler pino digital [PIN]",
    "microPythonEsp8266.pins.setDigitalOutput": "definir saída digital do pino [PIN] como [LEVEL]",
    "microPythonEsp8266.pins.setPinMode": "definir modo do pino [PIN] como [MODE]",
    "microPythonEsp8266.pins.setPwmOutput": "definir saída PWM do pino [PIN] como [OUT]",
    "microPythonEsp8266.pins.setServoOutput": "definir saída do pino de servo [PIN] como [OUT]",
...
"microbit.display.lightPixelAt": "[STATE] pixel no eixo x: [X], eixo y: [Y]",
...
"microbit.display.showUntilScrollDone": "mostrar [TEXT] até a rolagem terminar",
"microbit.displaySymbol": "mostrar [MATRIX]",
"microbit.displayText": "mostrar texto [TEXT]",
"microbit.gestruesMenu.faceDown": "com a face para baixo",
"microbit.gestruesMenu.faceUp": "com a face para cima",
"microbit.gestruesMenu.freefall": "em queda livre",
"microbit.gestruesMenu.shaken": "agitação",
...
"microbit.pins.setDigitalOutput": "definir pino digital [PIN] como [LEVEL]",
"microbit.pins.setPwmOutput": "definir saída PWM do pino [PIN] como [OUT]",
...
"microbit.sensor.lightLevel": "nível de luminosidade",
...
"microbit.whenPinConnected": "quando pino [PIN] conectado",
...
"music.changeTempo": "alterar ritmo em [TEMPO]",
...
"music.instrumentMarimba": "(19) Marimba",
"music.instrumentMusicBox": "(17) Caixinha de Música",
...
"music.setInstrument": "definir instrumento como [INSTRUMENTO]",
"music.setTempo": "definir ritmo como [TEMPO]",
...
"pen.setColor": "definir cor da caneta para [COLOR]",
...
"videoSensing.onFlipped": "ligado e invertido",
"videoSensing.setVideoTransparency": "definir transparência do vídeo para [TRANSPARENCY]",
...
"videoSensing.whenMotionGreaterThan": "quando o movimento do vídeo > [REFERENCE]",
"wedo2.getDistance": "distância",
"wedo2.getTiltAngle": "ângulo de inclinação [TILT_DIRECTION]",
"wedo2.isTilted": "inclinado [TILT_DIRECTION]",
"wedo2.motorDirection.backward": "para trás",
"wedo2.motorDirection.forward": "para frente",
