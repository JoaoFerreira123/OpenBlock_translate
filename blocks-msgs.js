...
export default {
  ...
  "pet-br": {
    ...
    "DATA_DELETEALLOFLIST": "apagar tudo de %1",
    ...
    "EVENT_WHENMICROPYTHONBEGIN": "quando o MicroPython iniciar",
    "EVENT_WHENMICROBITBEGIN": "quando o Microbit iniciar",
    "EVENT_WHENMICROBITBUTTONPRESSED": "quando o botão %1 for pressionado",
    "EVENT_WHENMICROBITPINBEINGTOUCHED": "quando o pino %1 for tocado",
    "EVENT_WHENMICROBITGESTURE": "quando o gesto %1 ocorrer",
    "EVENT_WHENFLAGCLICKED": "quando a bandeira %1 for clicada",
    ...
    "EVENT_WHENBROADCASTRECEIVED": "quando receber %1",
    ...
    "EVENT_WHENGREATERTHAN_LOUDNESS": "volume do som",
    "EVENT_BROADCAST": "enviar %1",
    "EVENT_BROADCASTANDWAIT": "enviar %1 e esperar",
    ...
    "LOOKS_EFFECT_GHOST": "transparência",
    "LOOKS_CHANGEEFFECTBY": "alterar efeito %1 por %2",
    "LOOKS_SETEFFECTTO": "definir efeito %1 como %2",
    "LOOKS_CLEARGRAPHICEFFECTS": "limpar efeitos visuais",
    ...
    "LOOKS_SETSTRETCHTO": "definir esticamento como %1 %",
    "LOOKS_SWITCHCOSTUMETO": "mudar traje para %1",
    "LOOKS_NEXTCOSTUME": "próximo traje",
    "LOOKS_SWITCHBACKDROPTO": "mudar cenário para %1",
    "LOOKS_GOTOFRONTBACK": "ir para a camada %1",
    "LOOKS_GOTOFRONTBACK_FRONT": "frente",
    "LOOKS_GOTOFRONTBACK_BACK": "trás",
    "LOOKS_GOFORWARDBACKWARDLAYERS": "ir para %1 camadas %2",
    ...
    "LOOKS_SWITCHBACKDROPTOANDWAIT": "mudar cenário para %1 e esperar",
    "LOOKS_NEXTBACKDROP_BLOCK": "próximo cenário",
    "LOOKS_PREVIOUSBACKDROP_BLOCK": "cenário anterior",
    ...
    "MOTION_POINTINDIRECTION": "apontar para direção %1",
    ...
    "MOTION_SETX": "definir x como %1",
    "MOTION_CHANGEYBY": "alterar y por %1",
    "MOTION_SETY": "definir y como %1",
    "MOTION_IFONEDGEBOUNCE": "se tocar na borda, quicar",
    "MOTION_SETROTATIONSTYLE": "definir estilo de rotação como %1",
    "MOTION_SETROTATIONSTYLE_LEFTRIGHT": "esquerda-direita",
    "MOTION_SETROTATIONSTYLE_DONTROTATE": "não rotacionar",
    "MOTION_SETROTATIONSTYLE_ALLAROUND": "todos os lados",
    "MOTION_XPOSITION": "posição x",
    "MOTION_YPOSITION": "posição y",
    "MOTION_DIRECTION": "direção",
    "MOTION_SCROLLRIGHT": "rolar para a direita %1",
    ...
    "MOTION_ALIGNSCENE_TOPLEFT": "superior-esquerda",
    "MOTION_ALIGNSCENE_TOPRIGHT": "superior-direita",
    "MOTION_XSCROLL": "rolagem x",
    "MOTION_YSCROLL": "rolagem y",
    "MOTION_STAGE_SELECTED": "Palco selecionado: nenhum bloco de movimento",
    "OPERATORS_ADD": "%1 + %2",
    "OPERATORS_SUBTRACT": "%1 - %2",
    "OPERATORS_MULTIPLY": "%1 * %2",
    "OPERATORS_DIVIDE": "%1 / %2",
    "OPERATORS_RANDOM": "escolher aleatoriamente de %1 a %2",
    "OPERATORS_GT": "%1 > %2",
    "OPERATORS_LT": "%1 < %2",
    "OPERATORS_EQUALS": "%1 = %2",
    "OPERATORS_AND": "%1 e %2",
    ...
    "OPERATORS_MATHOP_ACOS": "arco cosseno",
    "OPERATORS_MATHOP_ATAN": "arco tangente",
    "OPERATORS_MATHOP_LN": "logaritmo natural",
    "OPERATORS_MATHOP_LOG": "logaritmo",
    "OPERATORS_MATHOP_EEXP": "e elevado a",
    "OPERATORS_MATHOP_10EXP": "10 elevado a",
    ...
    "SENSING_COLORISTOUCHINGCOLOR": "cor %1 está tocando na cor %2?",
    ...
    "SENSING_SETDRAGMODE": "definir modo de arrasto como %1",
    ...
    "SENSING_USERID": "ID de usuário",
    "SOUND_PLAY": "tocar som %1",
    "SOUND_PLAYUNTILDONE": "tocar som %1 até o fim",
    ...
    "SOUND_EFFECTS_PAN": "pan esquerda/direita",
    "SOUND_CHANGEVOLUMEBY": "alterar volume por %1",
    "SOUND_SETVOLUMETO": "definir volume como %1%",
    "SOUND_VOLUME": "volume",
    "SOUND_RECORD": "gravar...",
    ...
    "SHOW_PROCEDURE_DEFINITION": "Ir para definição",
