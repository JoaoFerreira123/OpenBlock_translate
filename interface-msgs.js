...
export default {
  ...
  "pt-br":{
    "gui.alerts.lostPeripheralConnection": "OpenBlock perdeu a conexão com {extensionName}.",
    ...
    "gui.backpack.costumeLabel": "figurino",
    "gui.backpack.soundLabel": "som",
    "gui.backpack.scriptLabel": "roteiro",
    "gui.backpack.spriteLabel": "personagem",
    "gui.backpack.header": "Mochila",
    "gui.backpack.errorBackpack": "Erro ao carregar mochila",
    ...
    "gui.unsupportedBrowser.notRecommended": "Pedimos desculpas, mas parece que você está usando uma versão de navegador que o OpenBlock não suporta. Recomendamos atualizar para a versão mais recente de um navegador compatível, como o Google Chrome, Mozilla Firefox, Microsoft Edge ou Apple Safari.",
    "gui.unsupportedBrowser.description": "Pedimos desculpas, mas o OpenBlock não suporta este navegador. Recomendamos atualizar para a versão mais recente de um navegador compatível, como o Google Chrome, Mozilla Firefox, Microsoft Edge ou Apple Safari.",
    "gui.unsupportedBrowser.back": "Voltar",
    "gui.unsupportedBrowser.previewfaq": "Para saber mais, visite o {previewFaqLink}.",
    "gui.unsupportedBrowser.previewfaqlinktext": "FAQ",
    ...
    "gui.connection.auto-scanning.prescan": "Tenha o seu dispositivo por perto e comece a procurar.",
    ...
    "gui.connection.accessDeniedError.errorMessage": "Ops, acesso à porta serial negado. Verifique se a porta serial está ocupada.",
    ...
    "gui.connection.unavailable.installscratchlink": "Verifique se você tem o OpenBlock Link instalado e em execução",
    "gui.connection.unavailable.connectUsbEnableBluetooth": "Verifique se o cabo USB está conectado ou se o Bluetooth está ativado",
    ...
    "gui.crashMessage.label": "Ops! Algo deu errado.",
    "gui.crashMessage.description": "Pedimos desculpas, mas parece que o OpenBlock travou. Esse bug foi relatado automaticamente para a equipe do OpenBlock. Por favor, atualize a página para tentar novamente.",
    ...
    "gui.gui.costumesTab": "Figurinos",
    "gui.gui.soundsTab": "Sons",
    "gui.hardwareConsole.send": "Enviar",
    "gui.hardwareConsole.buadrate": "Taxa de transmissão",
    "gui.hardwareConsole.endOfLine": "Fim da linha",
    "gui.hardwareConsole.hexform": "Formato hexadecimal",
    "gui.hardwareConsole.autoScroll": "Rolagem automática",
    "gui.hardwareHeader.upload": "Enviar",
    "gui.stageHeader.codeStageSizeLarge": "Trocar para palco grande",
    "gui.stageHeader.codeStageSizeSmall": "Trocar para palco pequeno",
    "gui.stageHeader.hideStage": "Ocultar palco",
    ...
    "gui.library.filterPlaceholder": "Pesquisar",
    ...
    "gui.accountMenu.myStuff": "Meus Projetos",
    ...
    "gui.menuBar.LanguageSelector": "Seleção de Idioma",
    ...
    "gui.menuBar.restoreCostume": "Restaurar Figurino",
    ...
    "gui.menuBar.checkUpdate": "Verificar atualização",
    ...
    "gui.menuBar.uploadFirmware": "Carregar firmware",
    "gui.menu-bar.modeSwitchRealtime": "Tempo Real",
    "gui.menu-bar.modeSwitchRealtimeUpload": "Carregar",
    ...
    "gui.monitor.listMonitor.listLength": "tamanho {length}",
    "gui.monitor.contextMenu.default": "leitura normal",
    "gui.monitor.contextMenu.large": "leitura grande",
    ...
    "gui.playButton.play": "Reproduzir",
    ...
    "gui.playbackStep.playMsg": "Reproduzir",
    ...
    "gui.recordingStep.beginRecord": "Iniciar a gravação clicando no botão abaixo",
    "gui.recordingStep.permission": "{arrow}Precisamos da sua permissão para usar o microfone",
    ...
    "gui.soundEditor.play": "Reproduzir",
    ...
    "gui.stageHeader.stageSizeLarge": "Mudar para palco grande",
    ...
    "gui.stageSelector.addBackdropFromFile": "Enviar Cenário",
    ...
    "gui.telemetryOptIn.body2": "As informações que coletamos incluem seleção de idioma, uso de blocos e alguns eventos como salvar, carregar e enviar um projeto. NÃO coletamos nenhuma informação pessoal. Consulte nossa {privacyPolicyLink} para obter mais informações.",
    ...
    "gui.updateModel.tileCheckingForUpdate": "Verificando atualizações",
    "gui.updateModel.checkingTips": "Dependendo da sua rede, esta etapa pode levar alguns segundos, por favor, aguarde.",
    ...
    "gui.updateModal.deletingCompressedFile": "Excluindo arquivo compactado",
    "gui.updateModal.deletingCacheFile": "Excluindo arquivo de cache",
    "gui.updateModal.extractingCompressedFile": "Extraindo arquivo compactado",
    "gui.updateModal.verifyingCompressedFile": "Verificando arquivo compactado",
    "gui.updateModal.verifyingCacheFile": "Verificando arquivo de cache",
    "gui.updateModel.tileResourceUpdateFinish": "Atualização de recurso externo concluída",
    "gui.updateModal.resourceUpdateFinishTips": "Atualização de recurso externo concluída, o aplicativo será reiniciado automaticamente após 3 segundos.",
    "gui.updateModel.downloadingApplication": "Baixando aplicativo",
    "gui.updateModel.tileApplicationDownloadFinish": "Download do aplicativo concluído",
    "gui.updateModal.applicationDownloadeFinishTips": "Download do aplicativo concluído, ele será encerrado automaticamente e iniciará o instalador após 3 segundos.",
    "gui.uploadProgress.uploading": "Enviando",
    "gui.uploadProgress.uploadSuccess": "Envio concluído",
    "gui.uploadProgress.uploadError": "Erro ao enviar",
    "gui.uploadProgress.uploadTimeout": "Tempo limite de envio",
    "gui.uploadProgress.uploadAborted": "Envio cancelado",
    "gui.uploadProgress.abort": "Cancelar",
    "gui.uploadProgress.close": "Fechar",
    "gui.webglModal.label": "Seu Navegador Não Suporta WebGL",
    "gui.webglModal.description": "Infelizmente parece que seu navegador ou computador {webGlLink}. Essa tecnologia é necessária para executar o OpenBlock.",
    "gui.webglModal.webgllink": "não suporta WebGL",
    "gui.webglModal.back": "Voltar",
    "gui.webglModal.previewfaq": "Para saber mais, acesse o {previewFaqLink}.",
    "gui.webglModal.previewfaqlinktext": "FAQ",
    "gui.costumeLibrary.chooseABackdrop": "Escolher um Cenário",
    "gui.costumeLibrary.chooseACostume": "Escolher um Figurino",
    "gui.costumeTab.addBackdropFromLibrary": "Escolher um Cenário",
    "gui.costumeTab.addCostumeFromLibrary": "Escolher um Figurino",
    "gui.costumeTab.addBlankCostume": "Pintar",
    "gui.costumeTab.addSurpriseCostume": "Surpresa",
    "gui.costumeTab.addFileBackdrop": "Enviar Cenário",
    "gui.costumeTab.addFileCostume": "Enviar Figurino",
    "gui.deviceLibrary.chooseADevice": "Escolher um Dispositivo",
    "gui.deviceLibrary.deviceUrl": "Digite a URL do dispositivo",
    "gui.deviceLibrary.arduinoTag": "Arduino",
    "gui.deviceLibrary.microPythonTag": "MicroPython",
    ...
    "gui.spriteLibrary.chooseASprite": "Escolher um Sprite",
    "gui.tipsLibrary.tutorials": "Escolher um Tutorial",
    "gui.updateModal.updateWarning": "Os projetos não salvos serão perdidos. Deseja continuar a atualização e reiniciar?",
    "gui.uploadProgress.uploadErrorMessage": "Erro ao enviar",
    "gui.uploadProgress.uploadTimeoutMessage": "Tempo limite de envio",
    ...
    "gui.alerts.creating": "Criando novo projeto...",
    ...
    "gui.alerts.cloudInfo": "Observe que as variáveis na nuvem só suportam números, não letras ou símbolos. {learnMoreLink}",
    ...
    "gui.alerts.uploadSuccess": "Envio concluído com sucesso",
    ...
    "gui.alerts.codeEditorIsLocked": "O editor de código está bloqueado. Se você quiser editar o código, clique primeiro no botão de desbloqueio",
    "gui.alerts.codeEditorIsUnlocked": "O editor de código está desbloqueado. Se você quiser gerar código a partir de blocos, clique primeiro no botão de bloqueio",
    ...
    "gui.howtos.add-a-move-block.step_stepSay": "Adicionar um bloco de fala",
    ...
    "gui.howtos.animate-a-name.name": "Animação de um Nome",
    "gui.howtos.animate-a-name.step_AnimatePickLetter": "Escolher um Sprite de Letra",
    "gui.howtos.animate-a-name.step_AnimatePlaySound": "Tocar um Som Quando Clicado",
    "gui.howtos.animate-a-name.step_AnimatePickLetter2": "Escolher Outro Sprite de Letra",
    "gui.howtos.animate-a-name.step_AnimateChangeColor": "Mudar a Cor",
    "gui.howtos.animate-a-name.step_AnimateSpin": "Escolher Outro Sprite de Letra e Fazê-lo Girar",
    "gui.howtos.animate-a-name.step_AnimateGrow": "Escolher Outro Sprite de Letra e Fazê-lo Crescer",
    "gui.howtos.imagine": "Imagine um Mundo",
    "gui.howtos.imagine.step_imagineTypeWhatYouWant": "Digite o Que Você Quer Dizer",
    "gui.howtos.imagine.step_imagineClickGreenFlag": "Clique na Bandeira Verde para Começar",
    "gui.howtos.imagine.step_imagineChooseBackdrop": "Escolha Qualquer Cenário",
    "gui.howtos.imagine.step_imagineChooseSprite": "Escolha Qualquer Sprite",
    "gui.howtos.imagine.step_imagineFlyAround": "Pressione a Tecla de Espaço para Deslizar",
    "gui.howtos.imagine.step_imagineChooseAnotherSprite": "Escolha Outro Sprite",
    "gui.howtos.imagine.step_imagineLeftRight": "Mova para a Esquerda e para a Direita",
    "gui.howtos.imagine.step_imagineUpDown": "Mova para Cima e para Baixo",
    "gui.howtos.imagine.step_imagineChangeCostumes": "Mude os Trajes",
    "gui.howtos.imagine.step_imagineGlideToPoint": "Deslize até um Ponto",
    "gui.howtos.imagine.step_imagineGrowShrink": "Cresça e Encolha",
    "gui.howtos.imagine.step_imagineChooseAnotherBackdrop": "Escolha Outro Cenário",
    "gui.howtos.imagine.step_imagineSwitchBackdrops": "Troque os Cenários",
    "gui.howtos.imagine.step_imagineRecordASound": "Adicione um Som",
    "gui.howtos.imagine.step_imagineChooseSound": "Escolha o Seu Som",
    "gui.howtos.make-music.name": "Faça Música",
    "gui.howtos.Make-Music.step_PickInstrument": "Escolha um Sprite de Instrumento",
    "gui.howtos.Make-Music.step_PlaySoundClick": "Toque um Som Quando Clicado",
    "gui.howtos.Make-Music.step_MakeSong": "Crie uma Canção",
    "gui.howtos.make-music.step_MakeBeat": "Escolha uma Batida e Faça um Ritmo",
    "gui.howtos.make-music.step_MakeBeatBox": "Escolha o Sprite do Microfone e Faça uma Beatbox Surpresa",
    ...
    "gui.howtos.story.step_flip": "Vire a Direção",
    "gui.howtos.story.step_conversation": "Tenha uma Conversa",
    "gui.howtos.story.addanotherbg": "Adicione Outro Cenário",
    "gui.howtos.story.step_swithbg": "Troque os Cenários",
    ...
    "gui.howtos.chase-game.step_AddOcto": "Adicione um Sprite",
    "gui.howtos.make-music.step_LeftRight": "Mova para a Direita e para a Esquerda com as Teclas de Seta",
    "gui.howtos.Chase-Game.step_UpDown": "Mova para Cima e para Baixo com as Teclas de Seta",
    "gui.howtos.Chase-Game.step_AddStar": "Adicione Outro Sprite",
    "gui.howtos.Chase-Game.step_MoveRandom": "Mova Aleatoriamente",
    "gui.howtos.Chase-Game.step_WhenTouch": "No sprite do polvo, quando tocar, reproduzir som",
    "gui.howtos.Chase-Game.step_ScoreVariable": "Criar variável de pontuação",
    "gui.howtos.Chase-Game.ScoreWhenTouch": "No sprite do polvo, quando tocar, adicionar pontuação",
    "gui.howtos.animate-char.name": "Animar um Personagem",
    "gui.howtos.animate-char.step_addbg": "Adicionar um cenário",
    "gui.howtos.animate-char.step_addsprite": "Adicionar um sprite",
    "gui.howtos.animate-char.step_saysomething": "Dizer algo",
    "gui.howtos.animate-char.step_addsound": "Adicionar som",
    "gui.howtos.animate-char.step_animatetalking": "Animar falando",
    "gui.howtos.animate-char.step_arrowkeys": "Mover usando as teclas de seta",
    "gui.howtos.animate-char.step_jump": "Pular",
    "gui.howtos.animate-char.step_changecolor": "Mudar cor",
    "gui.howtos.make-a-game.name": "Criar um Jogo de Cliques",
    "gui.howtos.Make-A-Game.step_GamePickSprite": "Escolher um sprite",
    "gui.howtos.make-a-game.step_GamePlaySound": "Reproduzir som quando clicado",
    ...
    "gui.howtos.make-music.step_ResetScore": "Redefinir pontuação",
    "gui.howtos.make-it-fly.name": "Fazer voar",
    "gui.howtos.fly.step_stepflyChooseBackdrop": "Escolher um cenário de céu",
    ...
    "gui.howtos.add-a-move-block.step_stepflyMoveArrows": "Mover com as teclas de seta",
    ...
    "gui.howtos.pong.step_pongAddMoreCodeToBall": "Adicionar código para quicar a bola na raquete",
    "gui.howtos.pong.step_pongAddAScore": "Adicionar uma pontuação",
    "gui.howtos.pong.step_pongChooseScoreFromMenu": "Escolher 'Pontuação' no menu",
    "gui.howtos.pong.step_pongInsertChangeScoreBlock": "Inserir o bloco 'Alterar pontuação'",
    "gui.howtos.pong.step_pongResetScore": "Redefinir pontuação",
    "gui.howtos.pong.step_pongAddLineSprite": "Adicionar o sprite de linha",
    "gui.howtos.pong.step_pongGameOver": "Fim de jogo",
    "gui.howtos.code-cartoon": "Codificar um desenho animado",
    "gui.howtos.code-cartoon.step_codeCartoonSaySomething": "Dizer algo quando o botão verde for clicado",
    "gui.howtos.code-cartoon.step_codeCartoonAnimate": "Animar um personagem quando clicado",
    "gui.howtos.code-cartoon.step_codeCartoonSelectDifferentCharacter": "Selecionar um personagem diferente",
    "gui.howtos.code-cartoon.step_codeCartoonUseMinusSign": "Usar o sinal de menos para ficar menor",
    "gui.howtos.code-cartoon.step_codeCartoonGrowShrink": "Fazer um personagem crescer e encolher",
    ...
    "gui.howtos.code-cartoon.step_codeCartoonGlideAround": "Deslizar pelo cenário",
    ...
    "gui.howtos.cartoon-network.step_CNglide": "Deslizar pelo cenário",
    ...
    "gui.howtos.cartoon-network.step_CNbackdrop": "Nível avançado: mudar de cenário",
    ...
    "gui.howtos.say-it-out-loud": "Criar animações falantes",
    "gui.howtos.say-it-out-loud.step_AddTXTextension": "Adicionar os blocos de texto para fala",
    "gui.howtos.say-it-out-loud.step_TXTSpeech": "Dizer algo",
    "gui.howtos.say-it-out-loud_TXTSetVoice": "Definir uma voz",
    "gui.howtos.say-it-out-loud.step_TXTMove": "Mover-se",
    ...
    "gui.howtos.say-it-out-loud.step_TXTSong": "Cantar uma música",
    "gui.howtos.say-it-out-loud.step_TXTColor": "Mudar a cor",
    "gui.howtos.say-it-out-loud.step_TXTSpin": "Girar",
    "gui.howtos.say-it-out-loud.step_TXTGrow": "Crescer e encolher",
    "gui.howtos.talking": "Histórias falantes",
    "gui.howtos.talking.step_talesAddExtension": "Clique para adicionar os blocos de texto para fala",
    "gui.howtos.talking.step_talesChooseSprite": "Escolha um sprite",
    ...
    "gui.howtos.talking.step_talesChooseAnotherSprite": "Escolha outro sprite",
    "gui.howtos.talking.step_talesMoveAround": "Mover-se",
    "gui.howtos.talking.step_talesChooseAnotherBackdrop": "Escolha outro cenário",
    "gui.howtos.talking.step_talesAnimateTalking": "Animação falante",
    "gui.howtos.talking.step_talesChooseThirdBackdrop": "Escolha outro cenário",
    "gui.howtos.talking.step_talesChooseSound": "Escolha uma música para dançar",
    "gui.howtos.talking.step_talesDanceMoves": "Passos de dança",
    "gui.howtos.talking.step_talesAskAnswer": "Obter os blocos de pergunta e resposta da categoria de Sensor",
    "gui.howtos.add-sprite.name": "Adicionar um sprite",
    "gui.howtos.add-sprite.step_addSprite": "Adicionar um sprite",
    "gui.howtos.add-a-backdrop.name": "Adicionar um Plano de Fundo",
    "gui.howtos.add-a-backdrop.step_addBackdrop": "Adicionar um Plano de Fundo",
    "gui.howtos.change-size.name": "Alterar Tamanho",
    "gui.howtos.change-size.step_changeSize": "Alterar Tamanho",
    "gui.howtos.glide-around.name": "Deslizar em Torno",
    "gui.howtos.change-size.step_glideAroundBackAndForth": "Deslizar em Torno",
    "gui.howtos.change-size.step_glideAroundPoint": "Deslizar para um Ponto",
    "gui.howtos.record-a-sound.name": "Gravar um Som",
    "gui.howtos.change-size.step_recordASoundSoundsTab": "Clique na guia 'Sons'",
    ...
    "gui.howtos.change-size.step_recordASoundChooseSound": "Escolha o seu Som",
    "gui.howtos.change-size.step_recordASoundPlayYourSound": "Toque o seu Som",
    "gui.howtos.spin-video.name": "Fazer Girar",
    "gui.howtos.change-size.step_spinTurn": "Girar",
    "gui.howtos.change-size.step_spinPointInDirection": "Definir Direção",
    "gui.howtos.hide-and-show.name": "Esconder e Mostrar",
    "gui.howtos.change-size.step_hideAndShow": "Esconder e Mostrar",
    "gui.howtos.switch-costume.name": "Animar um Sprite",
    "gui.howtos.change-size.step_switchCostumes": "Animar um Sprite",
    "gui.howtos.move-around-with-arrow-keys.name": "Usar as Teclas de Setas",
    "gui.howtos.add-a-backdrop.step_moveArrowKeysLeftRight": "Mover para a Esquerda e Direita",
    "gui.howtos.add-a-backdrop.step_moveArrowKeysUpDown": "Mover para Cima e Baixo",
    "gui.howtos.add-effects.name": "Adicionar Efeitos",
    "gui.howtos.videosens.step_addEffects": "Adicionar Efeitos",
    "gui.device.esp32.description": "Placa de controle com Wi-Fi e Bluetooth e recursos avançados.",
    ...
    "gui.device.unselectDevice.description": "Desselecionar o dispositivo e retornar ao modo de programação em tempo real puro.",
    ...
    "gui.device.arduinoNano.description": "O Arduino Nano é uma pequena placa clássica para construir seus projetos.",
    ...
    "gui.device.microbit.description": "O computador de bolso que transforma a aprendizagem de habilidades digitais.",
    "gui.device.microbit.connectingMessage": "Conectando",
    "gui.device.microbitV2.description": "Processador atualizado, alto-falante e microfone embutidos, logotipo sensível ao toque.",
    ...
    "gui.device.k210MaixDock.description": "Uma placa de controle baseada no chip RISC-V K210 que possui apenas funções básicas e leva todos os pinos IO.",
    ...
    "gui.device.raspberryPiPicoIconURL.description": "A poderosa e flexível placa de microcontrolador.",
    ...
    "gui.extension.translate.description": "Traduza textos para vários idiomas.",
    "gui.extension.makeymakey.name": "Makey Makey",
    ...
    "gui.libraryTags.food": "Alimentos",
    ...
    "gui.libraryTags.wacky": "Estranho",
    ...
    "gui.projectLoader.loadError": "Falha ao carregar o arquivo do projeto selecionado.",
    ...
    "gui.sharedMessages.clearCacheWarning": "Certifique-se de que você deseja limpar o cache e reiniciar?",
